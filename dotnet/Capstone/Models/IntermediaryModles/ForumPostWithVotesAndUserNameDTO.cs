...
namespace Capstone.Models.IntermediaryModles
{
...

    {
        ...
        public ForumPostWithVotesAndUserName(long? parentPostId, int postId, string content, string title, string image, DateTime createDate, int userId, int forumId, int upVotes, int downVotes, bool isVisible, int depth)
        {
